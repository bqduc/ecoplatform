...
import static net.brilliance.officesuite.spreadsheet.XmlUtils.document;
import static net.brilliance.officesuite.spreadsheet.XmlUtils.searchForNodeList;
...
import net.brilliance.officesuite.spreadsheet.exceptions.MissingSheetException;
import net.brilliance.officesuite.spreadsheet.exceptions.OpenException;
import net.brilliance.officesuite.spreadsheet.exceptions.ReadException;
import net.brilliance.officesuite.spreadsheet.impl.StreamingSheetReader;
import net.brilliance.officesuite.spreadsheet.impl.StreamingWorkbook;
import net.brilliance.officesuite.spreadsheet.impl.StreamingWorkbookReader;
import net.brilliance.officesuite.spreadsheet.sst.BufferedStringsTable;
...
public class StreamingReader implements Iterable<Row>, AutoCloseable {
   ...
   *
   * @throws net.brilliance.officesuite.spreadsheet.exceptions.CloseException if there is an issue closing the stream
   */
  @Override
  public void close() {
    try {
  ...
  public static class Builder {
     ...
     * @throws net.brilliance.officesuite.spreadsheet.exceptions.ReadException if there is an issue reading the stream
     */
     ...
     * @throws net.brilliance.officesuite.spreadsheet.exceptions.OpenException if there is an issue opening the file
     * @throws net.brilliance.officesuite.spreadsheet.exceptions.ReadException if there is an issue reading the file
     */
