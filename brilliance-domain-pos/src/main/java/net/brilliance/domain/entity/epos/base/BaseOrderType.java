...
public abstract class BaseOrderType extends BizObjectBase {
	 ...
	 */
	public BaseOrderType (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	@Column(name = "showTableSelection")
	protected java.lang.Boolean showTableSelection;

	@Column(name = "showGuestSelection")
