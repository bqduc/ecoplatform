...
public class MenuItem extends BaseMenuItem {
	 ...
	 */
	public MenuItem(java.lang.Long id) {
		super(id);
	}
	 ...
	 */
	public MenuItem(java.lang.Long id, java.lang.String name, java.lang.Double buyPrice, java.lang.Double price) {
	...
	public boolean isPropertyValueTrue(String propertyName) {
		...
		return CommonUtility.getBoolean(property);
	}
	...
	public double getPriceByOrderType(OrderType type) {
		double defaultPrice = 0;//this.getPrice(Application.getInstance().getCurrentShift());
		if (type == null) {
			return defaultPrice;
		}
