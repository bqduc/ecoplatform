...
import net.brilliance.domain.entity.epos.base.BaseDiscount;
import net.brilliance.domain.model.ITicketItem;

@Entity
@Table(name = "vpos_discount")
...
public class Discount extends BaseDiscount {
	 ...
	 */
	public Discount (java.lang.Long id) {
		super(id);
	}
