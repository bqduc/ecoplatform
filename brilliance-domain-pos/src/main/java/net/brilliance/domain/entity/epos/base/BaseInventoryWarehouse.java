...
public abstract class BaseInventoryWarehouse extends BizObjectBase {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4533942714669570003L;
	 ...
	 */
	public BaseInventoryWarehouse(java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	 ...
	 */
	public BaseInventoryWarehouse(java.lang.Long id, java.lang.String name) {
		this.setId(id);
		this.setName(name);
		initialize();
	}
