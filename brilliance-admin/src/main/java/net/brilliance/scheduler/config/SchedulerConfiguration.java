...
public class SchedulerConfiguration {
	...
	/*
	 * @Inject private JobDefinitionManager jobDefinitionManager;
	 */
	...
	private List<Trigger> createTriggers() {
		...
		System.out.println("Data source: " + this.dataSource);
		// System.out.println("JobDefinitionManager: " + jobDefinitionManager);
	...
	public SchedulerFactoryBean schedulerFactoryBean(JobFactory jobFactory, Trigger simpleJobTrigger) throws IOException {
		...
		List<Trigger> triggers = createTriggers();
