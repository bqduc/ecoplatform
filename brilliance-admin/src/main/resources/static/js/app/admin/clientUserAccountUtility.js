...
var contextPrefix = '/rapi/clientUserAccount/';
var currentLanguageUrl = vnLanguageUrl;
var dataTableObject;
var objectTableId = '#clientUserAccountsTable';
		...
		"aoColumns": [
	          ...
	          {"mData": "userAccount",
				  ...
				  "render": function (data, type, row, meta){
					  return '<a href="'+row.id+'">' + data.ssoId +'</a>'; 
				  } 
	          }, 
	          {"mData": "userAccount",
		    	  "width": "15%",
				  "render": function (data, type, row, meta){
					  return '<a href="'+row.id+'">' + data.firstName +'</a>'; 
				  } 
	          }, 
	          {"mData": "userAccount",
		    	  "width": "25%",
				  "render": function (data, type, row, meta){
					  return '<a href="'+row.id+'">' + data.lastName +'</a>'; 
				  } 
	          }, 
	          {"mData": "userAccount",
		    	  "width": "25%",
				  "render": function (data, type, row, meta){
					  return '<a href="'+row.id+'">' + data.email +'</a>'; 
				  } 
	          }, 
	          {"mData": "issuedDate"},
	          {"mData": "activated"},
