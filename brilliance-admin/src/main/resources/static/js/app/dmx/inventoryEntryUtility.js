...
$(document).ready( function () {
	...
	console.log('COME');
	dataTableObject = $('#inventoryEntryTable').dataTable({
	 	"language": {
	 		"url": currentLanguageUrl
     	},
     	"pageLength":"50",
		"sAjaxSource": "/rapi/inventoryEntry/list",
		"sAjaxDataProp": "",
		"order": [[ 0, "asc" ]],
		"aoColumns": [
		      { "mData": "id", "width": "2%"},
	...
	$('#searchObjects').on('click', function(e){
		...
		refreshTable('#inventoryEntryTable', '/employee/searchEmployee?size='+size+'&page='+page);
	});
});