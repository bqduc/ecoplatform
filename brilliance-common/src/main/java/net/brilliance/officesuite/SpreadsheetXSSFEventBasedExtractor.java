...
public class SpreadsheetXSSFEventBasedExtractor {
	...
	public static Bucket extractSpreadsheetData(String spreadsheetFilePath, String[] sheets, Map<Object, Object> configParams) throws EcosysException {
		Bucket bucket = null;
		try {
	...
	public static Bucket extractSpreadsheetData(InputStream spreadsheetInputStream, Map<Object, Object> configParams) throws EcosysException {
		Bucket bucket = null;
		String[] sheetNames = null;
		try {
			sheetNames = (String[])configParams.get(Bucket.PARAM_DATA_SHEETS);
	...
	public Bucket extractData(String[] sheets, Map<Object, Object> configParams) throws InvalidOperationException, IOException, OpenXML4JException, SAXException{
		return extractData(ListUtility.arraysAsList(sheets), configParams);
	}

	public Bucket extractData(List<String> sheets, Map<Object, Object> configParams) throws InvalidOperationException, IOException, OpenXML4JException, SAXException{
